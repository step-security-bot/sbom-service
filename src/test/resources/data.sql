...
INSERT INTO product(id, name, attribute)
VALUES('59348869-abe7-416b-a360-8bed32d815f3', '/opt/repo-data/openEuler-22.03-LTS/update/x86_64', '{"productType":"openEuler", "version":"openEuler-22.03-LTS","imageFormat":"ISO","imageType":"update-test","arch":"x86_64"}'::jsonb)
ON CONFLICT (id) DO UPDATE
    SET name = EXCLUDED.name, attribute = EXCLUDED.attribute;
